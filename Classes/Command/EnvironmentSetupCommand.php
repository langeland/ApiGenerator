...
class EnvironmentSetupCommand extends \ApiGenerator\Command\AbstractCommand {
	...
	protected function execute(\Symfony\Component\Console\Input\InputInterface $input, \Symfony\Component\Console\Output\OutputInterface $output) {
		...
		$output->writeln('Available build sources. [ ' . implode(' | ', array_keys($this->configuration['source'])) . ' | all ]');
